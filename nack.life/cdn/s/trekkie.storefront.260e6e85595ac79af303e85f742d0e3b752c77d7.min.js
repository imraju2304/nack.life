            ...
            2971: function(e, t, n) {
                ...
                t.metricsSchemaId = "trekkie_metrics/2.0", t.errorsSchemaId = "trekkie_errors/2.0", t.setGlobalSerializedAppConfig = function(e) {
                    ...
                    if (this.shouldSendToBugsnag()) {
                        var n = "260e6e85595ac79af303e85f742d0e3b752c77d7",
                            o = null,
                            r = null,
                            i = null;
                        if (e.appConfig) try {
                    ...
                    c = function() {
                        ...
                        return e.prototype.fetchOrSet = function(e, t, n, o) {
                            ...
                            var a = r.read(n) || r.read(t),
                                s = !o;
                            a || (a = u(), s = !0, o && !this.isCookieSetServerSideEventFired && (i.logMetricToMonorail("serverSideCookieNotSet_" + n), this.isCookieSetServerSideEventFired = !0)), s && (r.write(t, a, e), r.write(n, a, e));
                            var c = r.read(n) || r.read(t);
                            return void 0 === c ? "00000000-0000-0000-5000-000000000000" : c
                    ...
                    C = function() {
                        ...
                        return e.prototype.configureMonorailRegion = function(e) {
                            ...
                            s.addBatchEvent({
                                ...
                                payload: {
                                    build_id: "260e6e85595ac79af303e85f742d0e3b752c77d7",
