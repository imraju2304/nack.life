...
Line 11:51 Transforming const to the configured target environment ("es5") is not supported yet
Line 11:510 Transforming const to the configured target environment ("es5") is not supported yet
Line 11:730 Transforming const to the configured target environment ("es5") is not supported yet
Line 11:1130 Transforming const to the configured target environment ("es5") is not supported yet
Line 11:1622 Transforming const to the configured target environment ("es5") is not supported yet
