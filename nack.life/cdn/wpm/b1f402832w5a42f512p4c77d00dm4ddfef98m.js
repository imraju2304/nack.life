(() => {
    ...
    n.amdO = {}, (() => {
        ...
        const be = "production",
            we = "0.0.354",
            ge = "modern",
            ve = "1f402832w5a42f512p4c77d00dm4ddfef98",
            ye = {
                        ...
                        try {
                            l = function(e, t) {
                                ...
                                const o = {
                                    ...
                                    columnNumber: "1",
                                    method: t.context,
                                    file: "https://cdn.shopify.com/b1f402832w5a42f512p4c77d00dm4ddfef98m.js"
                                };
        ...
        const At = ["31014027265", "28638674945", "44186959873"];
        ...
        function Rt(e, {
            ...
            const n = It(e);
            if (n && e[Tt](), t) {
                if (Array.isArray(e)) return e.reduce(((e, n) => Rt(n, {
                    deep: t
                }) || e), n);
                if ("object" == typeof e && null != e) return Object.keys(e).reduce(((n, o) => Rt(e[o], {
                    deep: t
                }) || n), n)
            }
            return n
        ...
        function Ut(e, t, n, o, r, i = !1) {
            ...
            return {
                analytics: {
                    subscribe: (r, a, s) => (i && Rt(a), e.subscribe(r, a, { ...s,
                        ...
                        try {
                            ...
                            const e = a.map((e => {
                                ...
                                return e.type = e.type.toUpperCase(), e.runtimeContext = null === (t = e.runtimeContext) || void 0 === t ? void 0 : t.toUpperCase(), async function({
                                    ...
                                    }(String(e.apiClientId), i)), await Promise.all([ht(), (u = (e, n) => t.subscribe(e, n, {
                                        pixelRuntimeConfig: {
                                            apiClientId: "PIXEL-LOADER"
                                        }
                                    }), d = null === (s = e.restrictions) || void 0 === s ? void 0 : s.preventLoadingBeforeEvent, new Promise(((e, t) => {
                                        void 0 === d ? e(!0) : u(d, (() => {
                                            e(!0)
                                        }))
                                    })))]), e.runtimeContext) {
                                ...
                                function(e, t) {
                                    $t("click", (t => {
                                        ...
                                        const o = function(e) {
                                            ...
                                            return null === e || (t.id = e.id, t.tagName = e.tagName, "href" in e && (t.href = e.href), "name" in e && (t.name = e.name), "type" in e && (t.type = e.type), "value" in e && (t.value = e.value)), t
                                        }(n);
                                ...
                                function(e, t) {
                                    $t("submit", (t => {
                                        ...
                                        for (let e = 0; e < n.elements.length; e++) {
                                            ...
                                            (t instanceof HTMLInputElement || t instanceof HTMLSelectElement || t instanceof HTMLTextAreaElement || t instanceof HTMLButtonElement) && o.push(Gt(t))
                                        }
                            ...
                            if (he("web_pixels_visitor_api")) {
                                ...
                                const e = (g = {
                                    ...
                                    visitor: (e, t) => function(e, t, n) {
                                        ...
                                        if (!o.valid) throw new Ft(o.error || "Invalid input payload to visitorApi");
                                        const r = { ...e,
                                            ...t,
                                            ...n
                                        };
